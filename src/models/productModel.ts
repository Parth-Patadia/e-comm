...
//     `insert into products(product_name,product_description, product_price, minimum_quantity, current_quantity, avg_rating, category_id) values
...
// export const fetchProdById = async (product_id: number) => {
...
// export const fetchAllProd = async() =>{
//     const allProd = await pool.query(`select * from products`);
//     return allProd.rows;
// }

// export const fetchProdByCat = async(category_id:number) =>{
//     const prodByCat = await pool.query(
//         `select * from products where category_id = $1`,
//         [category_id]
//       );
//       return prodByCat.rows;
// }

// export const checkPurchase = async(user_id:number,product_id:number) =>{
...
// export const addFeedback = async(user_id:number, product_id:number, rating:number, description:Text) =>{
//   const feedback = await pool.query(
//     "INSERT INTO feedback (user_id, product_id, rating, description) VALUES ($1, $2, $3, $4) RETURNING *",
...
//     "UPDATE products SET avg_rating = (SELECT AVG(rating) FROM feedback WHERE product_id = $1) WHERE product_id = $1",
//     [product_id]
//   );
// }

// export const allFeedback = async(product_id:number) =>{
